...
const paperStyle = computed(() => ({
    top: isAnimating.value ? '50%' : '40%', // Adjusted for horizontal layout
    left: isAnimating.value ? '50%' : '70%', // Slightly adjusted
    ...
    try {
        ...
        if (data.success) {
            ...
            tl.to(paper.value, {
                ...
                .to(paper.value, {
                    top: '55%', // Adjusted to be appropriate for horizontal layout
                    left: '50%',
                    rotation: 5,
                    scale: 0.8,
                    duration: 0.7,
