<template>
    <div class="min-h-screen bg-[#e6f5f0] py-16 px-4">
        <div class="max-w-5xl mx-auto">
            ...
            <!-- Main content container with stacked layout -->
            <div class="flex flex-col gap-8">
                ...
                <div
                    ...
                    <div class="p-8">
                        ...
                        <!-- Idea submission form - modified for landscape orientation -->
                        <form @submit.prevent="submitIdea" class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-5">
                            ...
                            <div class="space-y-5">
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            <label for="firstName"
                                                class="block text-sm font-semibold text-gray-700 mb-2">First
                                                Name*</label>
                                        ...
                                        <div>
                                            <label for="lastName"
                                                class="block text-sm font-semibold text-gray-700 mb-2">Last
                                                Name*</label>
                                ...
                                <div>
                                    <label class="inline-flex items-center">
                                        ...
                                        <span class="ml-2 text-gray-700 text-sm">Keep me updated on The Oaktree
                                            Empowerment
                            ...
                            <div class="space-y-5">
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="mt-4">
                                        <label for="category"
                                            class="block text-sm font-semibold text-gray-700 mb-2">Project
                                            Category*</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="description"
                                            class="block text-sm font-semibold text-gray-700 mb-2">Idea
                                            Description*</label>
                            ...
                            <!-- Submit button - centered at the bottom of the form -->
                ...
                <!-- Animation container - now below the form -->
                <div class="bg-white rounded-xl shadow-lg overflow-hidden relative">
                    <div class="animation-container relative w-full flex items-center justify-center"
                        style="height: 280px;">
                        ...
                        <div v-if="submissionStatus"
                            class="absolute bottom-2 w-full text-center text-lg font-medium px-4 py-2 rounded-lg transition-all duration-500"
                        ...
                        <div v-if="!isAnimating && !animationComplete"
                            class="text-center text-gray-500 absolute bottom-2 px-8">
