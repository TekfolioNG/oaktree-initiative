    ...
    <div class="content-wrapper">
      ...
      <div class="footer-message">
        <p>
          ...
          communities in need. <span class="highlight-link">SHARE YOUR FEEDBACK</span>
        </p>
      </div>
    </div>
  </section>
...
.contact-us-section {
  ...
  position: relative;
  /* Add this to make the header background positioning work */
  padding-top: 120px;
  /* Add padding to account for the header background */
}
...
.header-background {
  ...
  /* Dark green color */
  z-index: 0;
  /* Changed from -1 to ensure it's visible */
}

.content-wrapper {
  position: relative;
  /* Add this to ensure content is above the header background */
  width: 85%;
  max-width: 1200px;
  margin: 0 auto;
  text-align: center;
...
.section-title {
  ...
  font-weight: 600;
  margin-top: -100px;
  /* Pull the title up into the header background */
}

.subtitle {
  font-size: 1rem;
  color: #CAF7E8;
  /* Lighter green for contrast on dark background */
